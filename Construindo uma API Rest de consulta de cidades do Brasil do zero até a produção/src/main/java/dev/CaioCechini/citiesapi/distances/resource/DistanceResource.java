package dev.Caiocechini.citiesapi.distances.resource;

import dev.Caiocechini.citiesapi.distances.service.DistanceService;
...
public class DistanceResource {
    ...
    public DistanceResource(DistanceService distanceService) {
        this.disCaiocechinitanceService = distanceService;
    }
